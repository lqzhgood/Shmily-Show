                ...
                <div :key="s.label" class="sourceAndType" v-for="s in MSG_DICT.source">
                    ...
                    <el-checkbox-group class="type" v-model="searchForm.type[s.label]">
                        <el-checkbox :key="t" :label="t" class="item" v-for="t in s.type">
                            <img
                                :src="`./static/icon/source/${s.label}-${t}.png`"
                                class="icon"
                                v-if="s.label === 'CallLog'"
                            />
            ...
            <el-form-item class="durationWrap" label="通话长度" v-if="haveCallLog">
                <div class="duration">
                    <el-slider
                        ...
                        :max="MSG_DICT.$CallLog.data.duration[1]"
                        :min="MSG_DICT.$CallLog.data.duration[0]"
                        range
                        v-model="searchForm.$CallLog.data.duration"
                    ></el-slider>
                </div>
            </el-form-item>
