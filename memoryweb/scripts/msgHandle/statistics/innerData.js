...
const { ALL_SOURCE, ALL_YEAR } = require('./const.js');

// !!! import 路径没法使用变量 所以这里硬编码
const outDir = path.join(DIR_OUTPUT_IMPORT_STATISTIC, `./Msg/`);
fs.mkdirpSync(outDir);

fs.writeFileSync(path.join(outDir, `ALL_SOURCE.json`), JSON.stringify(ALL_SOURCE, null, 4));
